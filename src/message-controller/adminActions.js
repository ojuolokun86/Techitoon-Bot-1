...
const startFootballUpdates = async (sock, chatId) => {
    await startScheduler(sock, chatId);
};

const stopFootballUpdates = async (sock, chatId) => {
    await stopScheduler(sock, chatId);
};
